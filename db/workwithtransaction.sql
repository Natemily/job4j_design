...
insert into products (name, producer, count, price) VALUES ('product_6', 'producer_6', 28, 478);

savepoint second_savepoint;

insert into products (name, producer, count, price) VALUES ('product_7', 'producer_7', 35, 128);
insert into products (name, producer, count, price) VALUES ('product_8', 'producer_8', 48, 588);

savepoint third_savepoint;

delete from products where price = 478;
